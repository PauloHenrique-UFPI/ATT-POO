...
class Tela_Extrato(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(140, 0, 91, 91))
        font = QtGui.QFont()
        ...
        self.botao_voltar.setGeometry(QtCore.QRect(140, 200, 75, 23))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.botao_voltar.setFont(font)
        self.botao_voltar.setObjectName("botao_voltar")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(16, 90, 91, 20))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.lineEdit_2 = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_2.setGeometry(QtCore.QRect(120, 90, 151, 20))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_3.setText(_translate("MainWindow", "Data de Criação"))
